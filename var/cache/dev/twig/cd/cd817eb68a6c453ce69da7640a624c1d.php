...
class __TwigTemplate_91c51875935af933b888566d34fb405e extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        echo "</h3>
                <div id=\"articles-list\">
                    ";
        // line 12
        $this->loadTemplate("article/list.html.twig", "category/show.html.twig", 12)->display(twig_array_merge($context, ["articles" => (isset($context["articles"]) || array_key_exists("articles", $context) ? $context["articles"] : (function () { throw new RuntimeError('Variable "articles" does not exist.', 12, $this->source); })())]));
        // line 13
        echo "                </div>
            </div>
        </div>
...
";
    ...
    {
        return array (  100 => 13,  98 => 12,  93 => 10,  88 => 7,  78 => 6,  59 => 4,  36 => 1,);
    }
...
{% block body %}
    <main class=\"container\">
        <div class=\"row g-5\">
            <div class=\"col\">
                <h3 class=\"pb-4 mb-4 fst-italic border-bottom\">{{ category.name }}</h3>
                <div id=\"articles-list\">
                    {% include 'article/list.html.twig' with { articles : articles } %}
                </div>
            </div>
        </div>
    </main>
{% endblock %}
", "category/show.html.twig", "/home/turing/Bureau/plateforme/tuto/v3/templates/category/show.html.twig");
    }
}
