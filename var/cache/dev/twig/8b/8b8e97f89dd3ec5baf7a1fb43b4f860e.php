...
class __TwigTemplate_dac114672a8338c22196a0c4f17ac5c6 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            // line 2
            echo "    ";
            $this->loadTemplate("article/item.html.twig", "article/list.html.twig", 2)->display(twig_array_merge($context, ["article" => $context["article"]]));
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
<div class=\"container\">
    <div class=\"row\">
        <div class=\"d-flex align-items-center justify-content-center\">
            ";
        // line 8
        echo $this->extensions['Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension']->render($this->env, (isset($context["articles"]) || array_key_exists("articles", $context) ? $context["articles"] : (function () { throw new RuntimeError('Variable "articles" does not exist.', 8, $this->source); })()));
        echo "
        </div>
    </div>
</div>";
    ...
    {
        return array (  81 => 8,  75 => 4,  60 => 2,  43 => 1,);
    }
...
</div>", "article/list.html.twig", "/home/turing/Bureau/plateforme/tuto/v3/templates/article/list.html.twig");
    }
}
